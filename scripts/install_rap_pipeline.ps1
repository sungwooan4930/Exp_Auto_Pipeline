...
Write-Host "1. Open a project repository with RAP local files such as RAP_PROJECT_PROFILE.json, run_logging.md, and search_cycle_input.json."
Write-Host "2. Restart Claude Code if needed."
Write-Host "3. In Claude Code, type: rap-pipeline 시작"
Write-Host "4. Choose a stage when Claude asks."
